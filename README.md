# NOTE: This library is now read-only. Development is now taking place on the [OpenEphys.Bonsai.Miniscope](https://github.com/open-ephys/OpenEphys.Bonsai.Miniscope) repo.
